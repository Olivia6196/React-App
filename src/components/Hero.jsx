...
export default function Hero(){
    return(
        <>
        <div className="bg-[url(/background.png)] bg-cover bg-no-repeat bg-center flex flex-col lg:flex-row pt-16 lg:pt-32 gap-32 lg:gap-0">
            <div className="px-12 lg:px-48">
                <h1 className="pt-20 pb-2 text-4xl lg:text-3xl font-semibold">Hi, I'm Olivia<span><i class='bx bxs-heart bx-tada text-red-300 text-4xl align-middle drop-shadow-lg'></i></span></h1>
            ...
            <div>
                <img src={Pink} alt="profile picture" className="w-1/2 lg:w-[25vw] lg:h-[27vw] rounded-lg lg:rounded-full ml-20 lg:m-0" />
            </div>
        </div>
        </>
    )
